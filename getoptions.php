...
function select_value_set(SelectName)
{
   ...
   document.getElementById("res").innerHTML="TEST1";
   var v_str="111";
   document.getElementById("res").innerHTML="TEST2"+document.getElementById(SelectName).length;
   for (index=0;index<document.getElementById(SelectName).length;index++)
   {
	  v_str=v_str+""+document.getElementById(SelectName)[index].value;
   }
   document.getElementById("res").innerHTML=v_str;
...
<body>
			...
			<input type="button" onclick="select_value_set('country')" />
<div id="res"></div>
</body>
</html>
