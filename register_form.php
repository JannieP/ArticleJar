...
<title>ArticleJar.com - Register</title>
</head>
<body>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<form id="register1" name="register" method="post" action="register.php?voperation=register">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="3%">&nbsp;</td>
          <td width="21%">Email Address: </td>
          <td width="73%"><input type="text" name="emailaddress" size="50" value=""></td>
          <td width="3%">&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td>First Name: </td>
          <td><input type="text" name="firstname" size="50" value=""></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td><input type="text" name="adsense_id" size="50" value=""/></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          ...
          <td><input type="text" name="adsense_channel" size="50" value=""/></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
		...
		<tr>
		<td>
			<input type="submit" name="submit_register" value="Register" />	    </td>
			</tr>
			</table>
</td>
		<td>&nbsp;</td>
